...
const ListCardCategory = () => {
  ...
  const categories = [
    {
      title: 'Développement',
      imgSrc: `${process.env.PUBLIC_URL}/images/programme.jpg`,
    ...
    {
      title: 'Arts',
      imgSrc: `${process.env.PUBLIC_URL}/images/art.jpg`,
    ...
    {
      title: 'Voyages',
      imgSrc: `${process.env.PUBLIC_URL}/images/voyage.jpg`,
    ...
    {
      title: 'Sports',
      imgSrc: `${process.env.PUBLIC_URL}/images/sports.jpg`,
    ...
    {
      title: 'Langues',
      imgSrc: `${process.env.PUBLIC_URL}/images/langues.jpg`,
    ...
    {
      title: 'Cinéma',
      imgSrc: `${process.env.PUBLIC_URL}/images/films.jpg`,
